...
public class Ranking implements Comparable<Ranking> {
  ...
  public boolean equals(final Object o) {
    ...
    if (thisdtbId == null ? otherdtbId != null : !thisdtbId.equals(otherdtbId)) return false;
    ...
    if (thispoints == null ? otherpoints != null : !thispoints.equals(otherpoints)) return false;
    ...
    if (thisclub == null ? otherclub != null : !thisclub.equals(otherclub)) return false;
    final Object thisageGroup = this.getAgeGroup();
    final Object otherageGroup = other.getAgeGroup();
    if (thisageGroup == null ? otherageGroup != null : !thisageGroup.equals(otherageGroup)) return false;
    final Object thisposition = this.getPosition();
    final Object otherposition = other.getPosition();
    if (thisposition == null ? otherposition != null : !thisposition.equals(otherposition)) return false;
