...
public class RankingRepository {
  ...
  public void storeRankings(List<Ranking> rankings) {
    jdbcTemplate.batchUpdate("INSERT INTO RANKING " + "(DTBID, RANKINGPERIOD, LASTNAME, FIRSTNAME, POINTS, RANKINGPOSITION, NATIONALITY, FEDERATION, CLUB, AGEGROUP, YOBRANKINGS, OVERALLRANKING, ENDOFYEARRANKING) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
